...
const sortByChildren = (charArray) => {
  // Solution code here...
  // return charArray.sort((a,b)=>(b.children.length-a.childern.length))
};
...
Write a function named isCapitalized that takes in a string.
 This function should use a regular expression pattern to match
  all words that begin with a capital letter. It should only 
  match words, not punctuation.
...
const isCapitalized = (str) => {
  // Solution code here...
  let arr = str.split(' ')
  return arr.filter(item => item[0].toUpperCase())
