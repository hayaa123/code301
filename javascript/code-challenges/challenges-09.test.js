...
E.g. [4,2,7,5,9,2] -> 9
------------------------------------------------------------------------------------------------ */
// https://stackoverflow.com/questions/26089346/find-smallest-and-biggest-number-of-an-array-with-reduce-function-in-javascript

const maxInArray = (arr) => {
  // Solution code here...
  return arr.reduce((privios,current)=>{
     if (privios>current){
       return privios
     }
     else {
...
const updateNumbers = (obj) => {
  ...
  for (let propertie in obj ){
    arr.push(`${propertie}: ${obj[propertie]}`)
  }
  return arr
};
...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  let selected = arr.find(item=>item.name===character)
