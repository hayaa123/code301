...
Write a function nam ed firstLetters that takes in an array of strings and returns an array containing only the first letter of each string.
...
const findHappiness = (arr) => {
  // Solution code here...
  let regex = /(:\))/
  let new_arr =  arr.filter(str => regex.test(str))
  return new_arr
}
...
const standardizePhoneNumbers = (arr) => {
  ...
  let regex = /\W/g
    return arr.map(str => {
    // let spaceAndSpecial = str.match(regex)
    // console.log(spaceAndSpecial)
